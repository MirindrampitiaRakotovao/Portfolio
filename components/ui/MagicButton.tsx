...
const MagicButton = ({
  ...
  return (
    <button
      className={`relative inline-flex h-12 w-full mx-auto md:ml-40 mb-10 ml-20 md:mb-0 overflow-hidden rounded-lg p-[1px] focus:outline-none md:w-60 md:mt-10 ${otherClasses}`}
      onClick={handleClick}
    >
