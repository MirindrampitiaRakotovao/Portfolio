...
const MagicButton = ({
  ...
  return (
    <button className="relative inline-flex h-12 w-full md:ml-40 mb-10 ml-20 overflow-hidden rounded-lg p-[1px] focus:outline-none md:w-60 md:mt-10" onClick={handleClick}>
